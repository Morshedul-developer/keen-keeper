...
const FriendCard = ({ friend }) => {
  return (
      <Link to={`/friends/${friend.id}`} className="bg-base-100 shadow-md p-6 rounded-lg space-y-4 cursor-pointer hover:transform hover:scale-105 transition-transform duration-300">
        <figure>
          <img
            src={friend.picture}
            alt={friend.name}
